			...
			$.ajax({
				...
				success : function(data) {
					if (data.code==0010) {
						...
						$("#f").html(data.data.body.data[0].result.sum[0][0]);
						$("#g").html(data.data.body.data[0].result.sum[0][1]);
						$("#h").html(data.data.body.data[0].result.sum[0][2]);
						if(data.data.body.data[0].result.sum[0][3]=='--'){
							$("#i").html(data.data.body.data[0].result.sum[0][3]);
						}else{
							$("#i").html(data.data.body.data[0].result.sum[0][3]+"%");
						}
						$("#j").html(data.data.body.data[0].result.sum[0][4]);
